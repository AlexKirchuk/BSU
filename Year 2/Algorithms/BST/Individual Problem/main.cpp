...
а затем для каждой вершины определить, сколько
наибольших полупутей проходят через неё.
Note
Если после удаления в дереве остается одна вершина,
то считаем, что имеется один наибольший полупуть длины 0.
...
Output
Выполните прямой левый обход итогового дерева.
Для каждой вершины в отдельной строке выведите
через пробел её ключ и количество полупутей
наибольшей длины, проходящих через неё.
*/
#include <iostream>
#include <string>
#include <fstream>
